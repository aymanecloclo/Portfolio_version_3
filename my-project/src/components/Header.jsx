...
const Header = () => {
  ...
  return (
    <nav className=" lg:flex items-center border-gray-200 mx-0 lg:px-24 fixed top-0 left-0 w-full h-24 z-50 bg-[#F4FAFF] shadow-lg dark:bg-[#0c121b]">
      <div className="w-full  flex flex-wrap items-center justify-between my-0 py-4">
        ...
        <div className="w-full md:flex items-center md:w-auto md:gap-5  ">
          <AnimatePresence>
            {showMenu && (
              <motion.ul
                className=" bg-[#F4FAFF]  lg:bg-transparent text-center font-medium flex flex-col p-4 md:p-0  border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 dark:border-gray-700 dark:bg-[#0c121b]"
                initial={{ opacity: 0, y: -10 }}
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -10 }} // Keep the same animation everywhere
